...
Name:           ros-kilted-clips-vendor
Version:        6.4.4
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS clips_vendor package

License:        MIT-0
URL:            https://index.ros.org/p/clips_vendor/#kilted
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-kilted-ament-cmake-vendor-package
Requires:       unzip
...
* Sun Jun 22 2025 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - 6.4.3-1
- Autogenerated by Bloom
